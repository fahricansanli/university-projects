...
class Graph{
    ...
    //queue<int> process;  // kendim ekledim bilmiyorummmmmmmmmmmmmmm function idlerini tutuyor

public:
    stack<Function*> reversed;
    vector<Function*> reverse;
    ...
    void initTopologicalOrder(queue<Node *> &q, int *incSizes);

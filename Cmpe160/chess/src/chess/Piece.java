...
public abstract class Piece {
	 ...
	 */
	public abstract boolean canMove(int x, int y,int fromX,int fromY,int toX,int toY,Piece pieces[][]);
	 ...
	 */
	public abstract boolean canCapture(int x, int y,int fromX,int fromY,int toX,int toY,Piece pieces[][]);
